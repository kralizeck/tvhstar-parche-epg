...
# lanzo tvhstar.sh (el ficheroXML es el mismo que el definido en server.js), pero con src/server.js editado para que no descargue la guía (usará el preparado anteriormente) y no se quede en ejecución programada
./tvhstar.sh
